...
mlfw_column_vec_double * mlfw_substract_double_column_vector(mlfw_column_vec_double *left_vector,mlfw_column_vec_double *right_vector,mlfw_column_vec_double *difference_vector)
{
	double difference;
	index_t i;
	dimension_t left_vector_size;
