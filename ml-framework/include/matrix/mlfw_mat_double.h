...
mlfw_mat_double * mlfw_mat_double_from_csv(const char *csv_file_name,mlfw_mat_double *matix,mlfw_row_vec_string **header);
...
void mlfw_mat_double_fill(mlfw_mat_double *matrix,index_t start_row,index_t start_column,index_t end_row,index_t end_column,double value);	
...
mlfw_mat_double * mlfw_mat_double_transpose(mlfw_mat_double *matrix,mlfw_mat_double *tranposed_matrix);
